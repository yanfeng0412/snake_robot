...
def plot_velocity_curve(v_e, c_command, max_step = 100, dt =0.01, save_plot_path=None,figsize=(15, 10)):
    ...
    if save_plot_path is not None:
        plt.savefig(save_plot_path + '_vel_t.jpg')
    else:
        plt.show()

def plot_position_time(xyz, max_step = 100, dt =0.01, save_plot_path=None,figsize=(15, 10)):
...
def plot_traj_xy(xyz,max_step = 100, dt =0.01,  save_plot_path=None,figsize=(15, 10)):
    plt.figure(figsize=figsize)
