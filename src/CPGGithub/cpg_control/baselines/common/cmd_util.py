...
# import sys  
# sys.path.append('/home/a/fyp_ws/src/cpg_control/my_baselines')
import logger
...
def common_arg_parser():
    ...
    parser = arg_parser()
    parser.add_argument('--env', help='environment ID', type=str, default='Ant-v2')#Reacher-v2
    ...
    parser.add_argument('--load_path', help='Path to save trained model to', default=None, type=str) #/home/drl/PycharmProjects/rl_baselines/baselines/log-files/Mar_04_TRPO_Exp1/CellrobotEnvCPG-v0/No_1-CellrobotEnvCPG-v0_trpo_mpi-Mar-04_23:18:04/model/modelmodel
